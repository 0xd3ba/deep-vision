# main.py -- Entry point for training/testing WGAN model
...
from wgan import GeneratorCNN, CriticCNN
...
if __name__ == '__main__':
    ...
    critic_model = CriticCNN()

    train(data_loader, generator_model, critic_model, device)
