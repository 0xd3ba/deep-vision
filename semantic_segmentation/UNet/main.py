# main.py -- Entry point for training/testing UNet model
...
if __name__ == '__main__':
    ...
    data_class = VOC2012(DATASET_DIR, ANNOTATION_CSV, n_downsampling=4)     # UNet has 4 down-sampling operations
    model = UNet(n_classes=VOC2012.n_classes)
